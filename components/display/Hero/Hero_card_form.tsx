    ...
    return (
        <div className='z-10 text-white text-center flex justify-center w-full'>
            <form action="" className='w-full flex flex-col justify-center items-center'>
                <h3 className='text-lg  text-center px-[5%] pb-2 max-w-[450px]'>Ready to watch? Enter your email to create or restart your membership.</h3>
                <div className='flex flex-row flex-wrap justify-center'>
                    ...
                    <div className=' relative'>
                        ...
                        <input className='min-w-[350px] max-w-[950px] py-3  rounded-sm border-none outline-none my-2' type="email" name="" id="email_hero" maxLength={50} minLength={5} tabIndex={0} autoComplete="email" />
                    </div>
                    <div className='my-2'>
